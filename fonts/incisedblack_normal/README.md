...
import (
  ...
  _ "github.com/gmlewis/go-fonts-i/fonts/incisedblack_normal"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from incisedblack_normal"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "incisedblack_normal", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
