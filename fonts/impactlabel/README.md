...
import (
  ...
  _ "github.com/gmlewis/go-fonts-i/fonts/impactlabel"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from impactlabel"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "impactlabel", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
