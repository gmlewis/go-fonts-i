...
import (
  ...
  _ "github.com/gmlewis/go-fonts-i/fonts/im_fell_flowers_2"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from im_fell_flowers_2"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "im_fell_flowers_2", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
