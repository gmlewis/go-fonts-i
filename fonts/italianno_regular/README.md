...
import (
  ...
  _ "github.com/gmlewis/go-fonts-i/fonts/italianno_regular"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from italianno_regular"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "italianno_regular", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
