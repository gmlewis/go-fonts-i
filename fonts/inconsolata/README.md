...
import (
  ...
  _ "github.com/gmlewis/go-fonts-i/fonts/inconsolata"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from inconsolata"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "inconsolata", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
